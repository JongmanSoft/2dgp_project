...
open_canvas(800, 600)
current_scene = 0
scene = [title.Title(), text_scene.text_scene(0),text_scene.text_scene(1),bowling.bowling_scene(), air_hockey_scene.air_hockey_scene(),basket_ball.basket_ball_scene()]
